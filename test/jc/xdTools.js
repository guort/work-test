...
function paopao($opt){
	...
	,ele=createNode($opt.ele,"div",{className:"paopao"})
	,il=frameLen+1
	,i=0
	,space=divWidth
	...
	,sty=ele.style
	,time
	,scale=divWidth/frameWidth;
	if($opt.style)sty.cssText=$opt.style;
	sty.backgroundImage="url("+frameImg+")";
	sty.width=divWidth+"px";
	sty.height=divHeight+"px";
	sty.backgroundSize="auto "+divHeight+"px"	
...
function eventEntrust($opt){
	var ele=$opt.ele,event=$opt.event,action=$opt.action||"action",split=$opt.splitStr||".,";
		addEvent(ele,event,function(e){
			var ele=e.srcElement||e.target,attribute,argument,a1,fun=typeof($opt.fun)==="function"?$opt.fun:function(){};	
			do{
...
//			}
    ...
    "sex":2,
    "appget_tvmid":[
        "wxh582d47156701b00174dd0f63"
    ],
    "appget_user_bg":"",
    "user_address":"",
    "timestamp4QueryCode":1,
    "balance":"",
    "appget_app_mobile":"",
    "language":"zh_CN",
    "unionid":"oCLOAuBQjazK4nnnz_G4BzsSIHSE",
    "appget_sex":"",
    "province":"Beijing",
    "appget_kafka_status":0,
    "needGoback":0,
    "scope":"snsapi_userinfo",
    "sigExpire":1479362326,
    "appget_wx_token":"",
    "appget_info_status":0,
    "appget_creatTime":1,
    "refresh_token":"",
    "type":1,
    "expires_in":7200,
    ...
    "mobile_number":"",
    "integral":"",
    "appget_ttopenid":"orEt2t0E5ZTLHk8Ny5IsfnzZiGTI",
    "appget_area":null,
    "wechat":"o6dvnv1oLarAiY3p4wQ7qZbHHmyo",
    "weibbo":"",
    "ttopenid":"orEt2t0E5ZTLHk8Ny5IsfnzZiGTI",
    "ttdsbwx_token":"46497107fa23",
    "virtualCurrency":"",
    "longitude":116.4493551609525,
    "openid":"o6dvnv1oLarAiY3p4wQ7qZbHHmyo",
    "appget_app_nickname":"",
    "appget_nickname":"",
    "token":"",
    "qq":"",
    "isLogin":0,
    "mtqsign":"4eb60dfd9090dbea3768ad918e9c8203",
    "appget_addr":"",
    "appget_app_head_img":"",
    "ip":"10.0.1.138",
    "appget_receiver":"",
    "appget_sign_info":"",
    "uploadimgurl":"",
    "headimgurl":"http://wx.qlogo.cn/mmopen/ZJTL4IVribPPSNJKKoSP4RtQZIaCEqvGoUxWal49hiaye2BYRucN49OabwUQj7qUo0BODoOoErm67wNibjNrziaNFljFj2yABibwu/0",
    "appget_head_img":"",
    "macaddress":"F84550A0-9696-491A-BE4F-936DED3E03D3",
    "wxTokenSig":"51b374dd67f3cc83cd80d8626e09aedd",
    "hash":366280208,
    "yaoSig":"cf7e754163c6ae87a69e57885fd82a49",
    "appget_create_time":1,
    "latitude":39.93163292528095,
    "isBindWeChat":1,
    "tvmid":"wxh587c4853c3cbdf38442248e4",
    "street":"",
    "access_token":"",
    "userActivityStatus":10,
    "appget_constellation":"",
    "appget_active_time":1,
    "appget_channel_list":null,
    "isBindMobile":1,
    "nickname":"love.",
    "historyMacaddress":null,
    "appget_address":null,
    "appget_age":1,
    "unreadNum":0,
    "isBindQQ":0,
    ...
    "isChangeUserInfo":0,
	location:{lat:"39.95748",lng:"116.45504",region:"0-0-0-0",adcode:110100}
},"app")	

	function parseUS($data,$item){
		var data=toObject($data),pos;
		switch($item){
			case"app":
				...
				pos=data.location
				if(pos){
					userInfo.location=pos;
					pos.gps=pos.lat+","+pos.lng
				};
...
function qqDistance($opt){
	window.xd=function($data){
		var elements,distance=-1
		if($data.status===0){
			var result=$data.result||{};
			if(elements=result.elements){
			distance=elements[0].distance
			}
		}
		typeof($opt.fun)==="function"&&$opt.fun.call(null,distance)
	}
 var a=setJsonp("http://apis.map.qq.com/ws/distance/v1/?mode=driving&from="+$opt.from+"&to="+$opt.to+"&key=IPVBZ-BO4HG-MD3QU-I75W4-F7KUZ-PSBYI&callback=xd&output=jsonp")
